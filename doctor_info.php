                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <h5 class='mb-4'>Date of Birth:&nbsp;&nbsp;<span><?php echo $doctorInfos['age'] ?></span>
                                        </h5>
                                        <h5 class='mb-4'>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h5 class='mb-4'>
                                            Nrc:&nbsp;&nbsp;<span><?php echo $doctorInfos['nrc'] ?></span>
                                        </h5>
                                        ...
                                        <h5 class='mb-4'>
                                            Phone:&nbsp;&nbsp;<span><?php echo $doctorInfos['phone'] ?></span>
                                        </h5>

                                        <h5 class='mb-4'>
                                            Speciality:&nbsp;&nbsp;<span><?php echo $specialities[$doctorInfos['specialities']] ?></span>
                                        </h5>
